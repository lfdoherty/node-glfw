...
NAN_METHOD(GetMonitors) {
  ...
  for(i=0; i<monitor_count; i++){
    ...
    Nan::Set(js_monitor, JS_STR("is_primary"), JS_BOOL(monitors[i] == primary));
    Nan::Set(js_monitor, JS_STR("index"), JS_INT(i));

    Nan::Set(js_monitor, JS_STR("name"), JS_STR(glfwGetMonitorName(monitors[i])));

    glfwGetMonitorPos(monitors[i], &xpos, &ypos);
    Nan::Set(js_monitor, JS_STR("pos_x"), JS_INT(xpos));
    Nan::Set(js_monitor, JS_STR("pos_y"), JS_INT(ypos));

    glfwGetMonitorPhysicalSize(monitors[i], &width, &height);
    Nan::Set(js_monitor, JS_STR("width_mm"), JS_INT(width));
    Nan::Set(js_monitor, JS_STR("height_mm"), JS_INT(height));

    mode = glfwGetVideoMode(monitors[i]);
    Nan::Set(js_monitor, JS_STR("width"), JS_INT(mode->width));
    Nan::Set(js_monitor, JS_STR("height"), JS_INT(mode->height));
    Nan::Set(js_monitor, JS_STR("rate"), JS_INT(mode->refreshRate));

    modes = glfwGetVideoModes(monitors[i], &mode_count);
    js_modes = Nan::New<Array>(mode_count);
    for(j=0; j<mode_count; j++){
      js_mode = Nan::New<Object>();
      Nan::Set(js_mode, JS_STR("width"), JS_INT(modes[j].width));
      Nan::Set(js_mode, JS_STR("height"), JS_INT(modes[j].height));
      Nan::Set(js_mode, JS_STR("rate"), JS_INT(modes[j].refreshRate));
      // NOTE: Are color bits necessary?
      Nan::Set(js_monitor, JS_INT(j), js_mode);
    }
    Nan::Set(js_monitor, JS_STR("modes"), js_modes);
...
void NAN_INLINE(CallEmitter(int argc, Local<Value> argv[])) {
  ...
  if(Nan::Has(Nan::New(glfw_events), JS_STR("emit")).FromJust()) {
    // Local<Function> callback = Nan::New(glfw_events)->Get(JS_STR("emit")).As<Function>();
    Nan::Callback callback(Nan::Get(Nan::New(glfw_events), JS_STR("emit")).ToLocalChecked().As<Function>());
...
void APIENTRY windowPosCB(GLFWwindow *window, int xpos, int ypos) {
  ...
  Nan::Set(evt, JS_STR("type"),JS_STR("window_pos"));
  Nan::Set(evt, JS_STR("xpos"),JS_INT(xpos));
  Nan::Set(evt, JS_STR("ypos"),JS_INT(ypos));
...
void APIENTRY windowSizeCB(GLFWwindow *window, int w, int h) {
  ...
  Local<Array> evt=Nan::New<Array>(3);
  Nan::Set(evt, JS_STR("type"),JS_STR("resize"));
  Nan::Set(evt, JS_STR("width"),JS_INT(w));
  Nan::Set(evt, JS_STR("height"),JS_INT(h));
...
void APIENTRY windowFramebufferSizeCB(GLFWwindow *window, int w, int h) {
  ...
  Local<Array> evt=Nan::New<Array>(3);
  Nan::Set(evt, JS_STR("type"),JS_STR("framebuffer_resize"));
  Nan::Set(evt, JS_STR("width"),JS_INT(w));
  Nan::Set(evt, JS_STR("height"),JS_INT(h));
...
void APIENTRY windowRefreshCB(GLFWwindow *window) {
  ...
  Nan::Set(evt, JS_STR("type"),JS_STR("refresh"));
  Nan::Set(evt, JS_STR("window"),JS_NUM((uint64_t) window));
...
void APIENTRY windowIconifyCB(GLFWwindow *window, int iconified) {
  ...
  Local<Array> evt=Nan::New<Array>(2);
  Nan::Set(evt, JS_STR("type"),JS_STR("iconified"));
  Nan::Set(evt, JS_STR("iconified"),JS_BOOL(iconified));
...
void APIENTRY windowFocusCB(GLFWwindow *window, int focused) {
  ...
  Local<Array> evt=Nan::New<Array>(2);
  Nan::Set(evt, JS_STR("type"),JS_STR("focused"));
  Nan::Set(evt, JS_STR("focused"),JS_BOOL(focused));
...
void APIENTRY keyCB(GLFWwindow *window, int key, int scancode, int action, int mods) {
  ...
  Nan::Set(evt, JS_STR("type"), JS_STR( &actionNames[action << 3] ));
  Nan::Set(evt, JS_STR("ctrlKey"),JS_BOOL(mods & GLFW_MOD_CONTROL));
  Nan::Set(evt, JS_STR("shiftKey"),JS_BOOL(mods & GLFW_MOD_SHIFT));
  Nan::Set(evt, JS_STR("altKey"),JS_BOOL(mods & GLFW_MOD_ALT));
  Nan::Set(evt, JS_STR("metaKey"),JS_BOOL(mods & GLFW_MOD_SUPER));
  ...
  Nan::Set(evt, JS_STR("which"),JS_INT(which));
  Nan::Set(evt, JS_STR("keyCode"),JS_INT(key));
  Nan::Set(evt, JS_STR("charCode"),JS_INT(charCode));
...
void APIENTRY cursorPosCB(GLFWwindow* window, double x, double y) {
  ...
  Nan::Set(evt, JS_STR("type"),JS_STR("mousemove"));
  Nan::Set(evt, JS_STR("pageX"),JS_NUM(x));
  Nan::Set(evt, JS_STR("pageY"),JS_NUM(y));
  Nan::Set(evt, JS_STR("x"),JS_NUM(x));
  Nan::Set(evt, JS_STR("y"),JS_NUM(y));
...
void APIENTRY cursorEnterCB(GLFWwindow* window, int entered) {
  ...
  Local<Array> evt=Nan::New<Array>(2);
  Nan::Set(evt, JS_STR("type"),JS_STR("mouseenter"));
  Nan::Set(evt, JS_STR("entered"),JS_INT(entered));
...
void APIENTRY mouseButtonCB(GLFWwindow *window, int button, int action, int mods) {
  Nan::HandleScope scope;
  Local<Array> evt=Nan::New<Array>(7);
  Nan::Set(evt, JS_STR("type"),JS_STR(action ? "mousedown" : "mouseup"));
  Nan::Set(evt, JS_STR("button"),JS_INT(button));
  Nan::Set(evt, JS_STR("which"),JS_INT(button));
  Nan::Set(evt, JS_STR("x"),JS_INT(lastX));
  Nan::Set(evt, JS_STR("y"),JS_INT(lastY));
  Nan::Set(evt, JS_STR("pageX"),JS_INT(lastX));
  Nan::Set(evt, JS_STR("pageY"),JS_INT(lastY));
...
void APIENTRY scrollCB(GLFWwindow *window, double xoffset, double yoffset) {
  ...
  Nan::Set(evt, JS_STR("wheelDelta"),JS_NUM(yoffset*120));
...
NAN_METHOD(testJoystick) {
  ...
  double translateX = Nan::To<double>(info[2]).FromJust();
  double translateY = Nan::To<double>(info[3]).FromJust();
  double translateZ = Nan::To<double>(info[4]).FromJust();

  double rotateX = Nan::To<double>(info[5]).FromJust();
  double rotateY = Nan::To<double>(info[6]).FromJust();
  double rotateZ = Nan::To<double>(info[7]).FromJust();

  double angle = Nan::To<double>(info[8]).FromJust();
...
NAN_METHOD(testScene) {
  ...
  int width = Nan::To<int>(info[0]).FromJust();
  int height = Nan::To<int>(info[1]).FromJust();
  float z = info.Length()>2 ? (float) Nan::To<double>(info[2]).FromJust() : 0;
  float ratio = width / (float) height;
...
NAN_METHOD(WindowHint) {
  ...
  int hint         = Nan::To<int>(info[1]).FromJust();
...
NAN_METHOD(JoystickPresent) {
  Nan::HandleScope scope;
  int joy = Nan::To<int>(info[0]).FromJust();
...
NAN_METHOD(glfw_CreateWindow) {
  ...
  int width       = Nan::To<int>(info[0]).FromJust();
  int height      = Nan::To<int>(info[1]).FromJust();
  Nan::Utf8String str(info[2]);//Nan::To<v8::String>(info[2]).ToLocalChecked());
  int monitor_idx = Nan::To<int>(info[3]).FromJust();
  ...
  glfw_events.Reset(Nan::Get(info.This(),JS_STR("events")).ToLocalChecked().As<Object>());//->ToObject());
...
NAN_METHOD(GetWindowSize) {
  ...
  if(handle) {
    ...
    Nan::Set(arr, JS_STR("width"),JS_INT(w));
    Nan::Set(arr, JS_STR("height"),JS_INT(h));
    info.GetReturnValue().Set(arr);
  }
  return;
}
...
NAN_METHOD(GetWindowPos) {
  ...
  if(handle) {
    ...
    Local<Array> arr=Nan::New<Array>(2);
    Nan::Set(arr, JS_STR("xpos"),JS_INT(xpos));
    Nan::Set(arr, JS_STR("ypos"),JS_INT(ypos));
    info.GetReturnValue().Set(arr);
  }
  return;
}
...
NAN_METHOD(GetFramebufferSize) {
  ...
  if(handle) {
    ...
    Local<Array> arr=Nan::New<Array>(2);
    Nan::Set(arr, JS_STR("width"),JS_INT(width));
    Nan::Set(arr, JS_STR("height"),JS_INT(height));
    info.GetReturnValue().Set(arr);
  }
  return;
}
...
NAN_METHOD(GetWindowAttrib) {
  Nan::HandleScope scope;
  uint64_t handle = Nan::To<int64_t>(info[0]).FromJust();
  int attrib=Nan::To<int>(info[1]).FromJust();
  if(handle) {
    GLFWwindow* window = reinterpret_cast<GLFWwindow*>(handle);
...
NAN_METHOD(GetKey) {
  Nan::HandleScope scope;
  uint64_t handle = Nan::To<int64_t>(info[0]).FromJust();
  int key=Nan::To<int>(info[1]).FromJust();
  if(handle) {
    GLFWwindow* window = reinterpret_cast<GLFWwindow*>(handle);
...
NAN_METHOD(GetMouseButton) {
  Nan::HandleScope scope;
  uint64_t handle = Nan::To<int64_t>(info[0]).FromJust();
  int button=Nan::To<int>(info[1]).FromJust();
  if(handle) {
    GLFWwindow* window = reinterpret_cast<GLFWwindow*>(handle);
...
NAN_METHOD(GetCursorPos) {
  ...
  if(handle) {
    ...
    Local<Array> arr=Nan::New<Array>(2);
    Nan::Set(arr,JS_STR("x"),JS_NUM(x));
    Nan::Set(arr,JS_STR("y"),JS_NUM(y));
    info.GetReturnValue().Set(arr);
  }
  return;
}
...
NAN_METHOD(SwapInterval) {
  Nan::HandleScope scope;
  int interval=Nan::To<int>(info[0]).FromJust();
...
//
///////////////////////////////////////////////////////////////////////////////
#define JS_GLFW_CONSTANT(name) target->Set(Nan::GetCurrentContext(), JS_STR( #name ), JS_INT(GLFW_ ## name)).FromJust()
